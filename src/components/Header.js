...
const Header = (props) => (
    <header id="header">
        ...
        <p>            
            ...
            <b>Thanks for your participation! EMISAJ special issue</b><br/>
        </p>
        <ul className="icons">
            ...
            <li><a href="https://easychair.org/conferences/?conf=tpsie2019" target="_blank" rel="noopener noreferrer" className="icon fa-paper-plane alt" title="Submit Paper"><span className="label">Submit</span></a></li>
        </ul>        
    </header>
)
