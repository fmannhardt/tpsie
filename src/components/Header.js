...
const Header = (props) => (
    <header id="header">
        ...
        <ul className="icons">
            <li><a href="https://twitter.com/search?src=typd&q=%23tpsie19" className="icon fa-twitter alt" title="Share on Twitter"><span className="label">Twitter</span></a></li>
            ...
            <li><a href="https://easychair.org/conferences/?conf=tpsie2019" className="icon fa-paper-plane alt" title="Submit Paper"><span className="label">Submit</span></a></li>
        </ul>        
    </header>
)
